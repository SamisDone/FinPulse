...
-- One row per browser that has been left signed in. The cookie carries
-- "selector:validator"; only the selector is stored in the clear, so a copy of
-- this table is not enough to sign in as anybody.
