...
{
    $pdf = new PdfDocument('FinPulse report · ' . $report['range_label'], $user['username']);
    ...
    $generated = 'Generated by FinPulse on ' . date('M j, Y \a\t g:i a');
