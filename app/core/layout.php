...
{
    $description = $opts['description'] ?? 'Sixpence is a personal finance tracker for income, spending, budgets and savings goals.';
    $full_title = $title === 'Sixpence' ? $title : $title . ' · Sixpence';
    ?>
<!doctype html>
<html lang="en">
<head>
